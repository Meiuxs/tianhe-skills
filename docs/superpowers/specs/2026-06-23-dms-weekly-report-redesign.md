...
14. 项目管理部核价审批人        ← 原"采购审批人"列位置
15. 项目管理部核价审批状态      ← 原"采购审批状态"列位置
16. 项目管理部核价审批时间      ← 新增
17. 省总审批人                  ← 保持原内容
18. 省总审批状态                ← 保持原内容
19. 审批完成时间                ← 保持原内容
...
> **说明：** 去掉「是否下单」(-1)，新增「是否有效」(+1)、「项目管理部核价审批时间」(+1)，净增加 1 列，共 20 列。

> **修正说明：** 经确认，去掉「是否下单」(-1) + 新增「是否有效」(+1) + 新增「项目管理部核价审批时间」(+1) + 采购审批人替换为项目管理部核价审批人(不改列数) = 共 **20 列**。
