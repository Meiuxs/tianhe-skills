...
from column_definitions import (
    ...
    COL_UNIT_PRICE, COL_TOTAL_PRICE, COL_SUBMIT_TIME, COL_REMARK, COL_ORDERED,
    COL_PROVINCE_PROCESSOR, COL_PROVINCE_STATUS, COL_PURCHASE_PROCESSOR, COL_PURCHASE_STATUS,
...
class TestColumnDefinitions(unittest.TestCase):
    ...
    def test_headers_count(self):
        """测试表头数量。"""
        self.assertEqual(len(HEADERS), 19, "应该有 19 列")
    ...
    def test_specific_headers(self):
        ...
        self.assertEqual(HEADERS[COL_ORDERED], "是否下单")
